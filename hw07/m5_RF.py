...
print(confmat)
print('------------------------')
print('RF-Test Accuracy: %.3f' % rf.score(X_test, y_test))
print('RF-Precision: %.3f' % precision_score(y_true=y_test, y_pred=y_pred,average='weighted', zero_division=1))
print('RF-Recall: %.3f' % recall_score(y_true=y_test, y_pred=y_pred ,average='weighted'))
print('RF-F1: %.3f' % f1_score(y_true=y_test, y_pred=y_pred ,average='weighted'))
print('RF-AUC: %.3f' % auc)
